<!-- Modal -->
<div class="modal fade" id="popupUpdateAccount" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
	...
	<?php echo form_close() ?>
	<script>
		$('#popupUpdateAccount').on('hidden.bs.modal', function(e){
			$(this).remove();
		});
